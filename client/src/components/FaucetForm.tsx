...
const FaucetForm = (props: any) => {
    ...
    chainConfigs?.forEach((chain: any, i: number) => {
      ...
      let item = (
        <div className="select-dropdown">
          ...
          >
            {chain.CONTRACTADDRESS ? "BEP20" : "Native"}
          </span>
        </div>
      );
  ...
  return (
    <div className="container--">
      ...
      <div className="parent shadow m-auto cyberpunk-bg-light">
        <div className="box">
          ...
          <div className="box-content">
            <div className="box-header">
              <span>
                <span className="text_style"> Network</span>
              </span>
              <ChainDropdown /> <br />
              <div>
                <div style={{ width: "100%" }}>
            ...
            >
              ...
              <div style={{ color: "#ff5252", fontSize: "12px" }}>
                <p>Note:This is a testnet faucet. Funds are not real.</p>
              </div>
